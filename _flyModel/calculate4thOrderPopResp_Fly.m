...
for j=1:length(dSteps)
    ...
    save(['flyPop4thOrderResp_',num2str(oCorr),'_',num2str(Sc),'_iter_',num2str(popRespIter),'.mat'],'agr90base','T50base','T90base','rAgr90','oCorr','dSteps','kSteps','N4','rAcc','rCC','gCC','rCCpSum','rCCSingle','rAgr','rAgrSingle','rAgrSum','RExSingle','REx','REx2','RExU','REx2U','Nsingle','snr');
