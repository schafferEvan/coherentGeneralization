...
global Nx Ny Sx Sc ScInh exInhBalance glomExpMean glomExpMin glomExpMax Sp NoR NoC NoM classOdorOverlap N4 S4 S4c templateOdor Jmax glomActMu glomActSig thMean thVar outlierThresh classLevel1 classLevel2 greenColorAdjust class1Color class2Color
...
Nx = 50; %number of glomeruli
Ny = 10000; %number of piriform neurons
N4 = 50; %number of readouts used in population analysis

Sx = 0.2; % statement at right isn't true b/c of glomExpMin %.14; %fraction of glomeruli activated by an odor -- 14% exp gives 10% accounting for 95% of activity
Sc = 7/50; %.2; %prob of conn from glom to pir
ScInh = 1; %.4;
