...
dSteps = round(logspace(0,7,50)); %round(logspace(2,3,5)); %round(logspace(3,6.69,28)); %round(logspace(3,6,28)); %round(logspace(2,4,10)); %
dSteps = dSteps(1:30);
...
for j=1:length(dSteps)
    ...
    save([fol,'pop4thOrderRespSmall_',num2str(oCorr),'_iter_',num2str(popRespIter),'.mat'],'agr90base','T50base','T90base','rAgr90','oCorr','dSteps','kSteps','N4','rAcc','rCC','gCC','rCCpSum','rCCSingle','rAgr','rAgrSingle','rAgrSum','Nsingle','snr');
