...
dSteps = round(logspace(0,7,30)); %round(logspace(0,7,30));
dSteps = dSteps(1:20);
...
for j=1:length(dSteps)
    ...
    T50base1 = T50base1 + eps*randn(size(T50base1)); % jitter threshold to avoid duplicate median issue
    ...
    save(['pop4thOrderResp_POP_',num2str(oCorr),'_iter_',num2str(popRespIter),'_small.mat'],'agr90base','T50base','T90base','rAgr90','oCorr','dSteps','pSteps','N4','rAgr');%,'T50baseUn','T90baseUn','rAgr90Un','rAgrUn');
