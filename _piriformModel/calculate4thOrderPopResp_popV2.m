...
dSteps = round(logspace(0,7,20)); %round(logspace(0,7,30));
...
for j=1:length(dSteps)
    ...
    save(['pop4thOrderResp_POP_',num2str(oCorr),'_iter_',num2str(popRespIter),'.mat'],'agr90base','T50base','T90base','rAgr90','oCorr','dSteps','pSteps','N4','rAgr','T50baseUn','T90baseUn','rAgr90Un','rAgrUn');
