...
dSteps = dSteps(1:29);
xsSteps = [.05,.1,.2]; %.02:.02:.3; %input sparseness
N4 = 1; %200;
iters = 1; %10;
...
for i=1:iters
    for j=1:length(dSteps)
        ...
        save(['popRespVsSparsenss_thM_small_',num2str(oCorr),'_iter_',num2str(popRespIter),'.mat'],'ZCat','Z2Cat','agr90base','T50base','T90base','rAgr90','oCorr','dSteps','xsSteps','N4','rAcc','rCC','rCCpSum','rCCSingle','rAgr','rAgrSingle','rAgrSum','RExSingle','REx','REx2','RExU','REx2U','snr');
